...
LOCAL_PREBUILT_LIBS := \
	...
	lib/lib_omx_https_pipe_v2_arm11_elinux.so \
	\
	...
	lib/lib_omx_streaming_parser_arm11_elinux.so \
	\
	...
	lib/lib_omx_aac_enc_v2_arm11_elinux.so \
	...
	lib/lib_ffmpeg_arm11_elinux.so \
	\
	lib/libstagefrighthw.so \


ifeq ($(BOARD_SOC_CLASS),IMX5X)
LOCAL_PREBUILT_LIBS +=  lib/lib_omx_vpu_dec_v2_arm11_elinux.so \
...
LOCAL_PREBUILT_LIBS += lib/lib_omx_surface_render_arm11_elinux.so
endif
